...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-teal-400 text-left text-base font-medium text-teal-700 bg-teal-50 focus:outline-none focus:text-teal-400 focus:bg-teal-100 focus:border-teal-700 transition duration-150 ease-in-out'
